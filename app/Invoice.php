...
class Invoice extends Model
{
    ...
    protected $fillable = ['intern_name','invoice_id', 'user_id', 'project_id', 'title','content', 'number','company_name','company', 'bank', 'bank_branch', 'bank_account_number', 'bank_account_name', 'receipt', 'receipt_date', 'remuneration', 'price', 'detail_file', 'receipt_file', 'status','finished_id','purchase_id','reviewer'];
