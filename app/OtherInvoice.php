...
class OtherInvoice extends Model
{
    ...
    protected $fillable = ['other_invoice_id', 'user_id','title', 'content', 'number','company_name','company', 'bank','type', 'bank_branch', 'bank_account_number', 'bank_account_name', 'receipt', 'receipt_date', 'remuneration', 'price', 'detail_file', 'receipt_file', 'status','reviewer','finished_id','purchase_id'];
