                            ...
                            <div class="col-lg-6">
                                <div id="days">
                                    <div class="form-group">
                                        ...
                                        <input onchange="calculation('days')" autocomplete="off" type="date" id="start_day" name="start_day" class="form-control rounded-pill" value="{{ old('start_day') }}">
                                    </div>
                                    <div class="form-group ">
                                        <label for="end_day" class="col-form-label ">結束日期</label>
                                        <input onchange="calculation('days')" autocomplete="off" type="date" id="end_day" name="end_day" class="form-control rounded-pill" value="{{ old('end_day') }}">
                                    </div>
                                </div>
                                <div id="day" hidden>
                                    <div class="form-group ">
                                ...
                                <div id="hours" hidden>
                                    <div class="form-group ">
                                        ...
                                        <input onchange="calculation('hours')" autocomplete="off" type="time" id="start_time" name="start_time" class="form-control rounded-pill" value="{{ old('start_time') }}">
                                    </div>
                                    <div class="form-group ">
                                        <label for="end_time" class="col-form-label ">結束時間</label>
                                        <input onchange="calculation('hours')" autocomplete="off" type="time" id="end_time" name="end_time" class="form-control rounded-pill" value="{{ old('end_time') }}">
                                    </div>
                                </div>
                                <div id="day_long">
                                    <div class="form-group ">
