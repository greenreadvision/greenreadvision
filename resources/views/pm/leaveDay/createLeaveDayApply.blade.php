...
<div class="d-flex justify-content-center">
    <div class="col-lg-10">
        ...
        <form action="/leaveDayApply/{{$leaveDayId}}/create/review" method="post">
            @else
            <form action="/leaveDayApply/create/review" method="post">
                @endif
                @csrf
                <div class="row">
                ...
                <form action="/leaveDayApply/{{$leaveDayId}}/create/review" method="post">
                    ...
                    <form action="/leaveDayApply/create/review" method="post">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <li><label class="col-form-label">事由</label><input autocomplete="off" type="text" name="content" class="form-control{{ $errors->has('content') ? ' is-invalid' : '' }}" required></li>
                            </div>
                        </div>
                        <hr>
                        <div style="float: right;">
